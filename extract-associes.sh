#!/bin/bash
echo "rccm,civilite,prenom,nom,postNom,sexe,dateNaissance,paysNaissance,lieuNaissance,numeroPieceIdentite,adresse,email,telephoneMobile,nbPartsSociales"
jq -r "
  .details |
  {
